...
// jsdom (the environment the DOM-facing tests opt into) does not implement the Popover API, so provide no-op shims for the lifecycle methods our components call.
